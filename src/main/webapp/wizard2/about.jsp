...
<div class="super_container">
	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul>
				...
				<li class="menu_item"><a href="services.jsp">Servicios</a></li>
				<li class="menu_item"><a href="news.jsp">Noticias</a></li>
				<li class="menu_item"><a href="contact.jsp">Contactanos</a></li>
			</ul>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="section_title">Sobre Nosotros</div>
					<div class="section_subtitle">Informe Breve</div>
				</div>
			</div>
			<div class="row about_row row-eq-height">
				<div class="col-lg-4">
					...
					<div class="about_text_highlight">Aseguramos la experiencia positiva de nuestros pacientes.</div>
					<div class="about_text">
						<p>Enfocandonos en la calidad de nuestro trabajo.</p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="about_text_2">
						<p>Somos una red de Clinica y Centros medicos a nivel nacional, con la tecnologia mas moderna y el Staff medico mas comprometido con la salud de nuestros pacientes y la de su familia.</p>
					</div>
				</div>
				<div class="col-lg-4">
			...
			<div class="row">
				<div class="col">
					<div class="button about_button ml-auto mr-auto"><a href="#"><span>Llama ya</span><span>Llama ahora</span></a></div>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-start">
						...
						<div class="milestone_content">
							...
							<div class="milestone_text">Dias del Año</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-start">
						...
						<div class="milestone_content">
							...
							<div class="milestone_text">Pacientes al año</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-start">
						...
						<div class="milestone_content">
							...
							<div class="milestone_text">Los medicos sorprendentes</div>
						</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-start">
						...
						<div class="milestone_content">
							...
							<div class="milestone_text">Resultado de Citas</div>
						</div>
					</div>
				</div>
				...
				<div class="col">
					<div class="cta_container d-flex flex-xl-row flex-column align-items-xl-start align-items-center justify-content-xl-start justify-content-center">
						<div class="cta_content text-xl-left text-center">
							<div class="cta_title">Haga una cita con uno de nuestros medicos profesionales.</div>
	...
	<div class="doctors">
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="section_title">Nuestros doctores</div>
					<div class="section_subtitle">Selecionar</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col">
					<div class="button doctors_button ml-auto mr-auto"><a href="#"><span>todos los medicos</span><span>todos los medicos</span></a></div>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="row">
					...
					<div class="col-lg-3 footer_col">
						<div class="footer_about">
							...
							Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos los derechos reservados | Esta plantilla se hace con <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://www.cibertec.edu.pe/" target="_blank">Cibertec</a>
