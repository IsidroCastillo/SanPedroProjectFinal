	...
	<div class="super_container">
		...
		<div class="home">
			<div class="background_image"
				style="background-image: url(images/index_hero.jpg)"></div>
									...
									<div class="col">
										<div
											...
											<div class="search_content d-flex flex-row align-items-center
													...
													<ul>
														<li><a href="login.jsp" class="reserva text-uppercase">Pide tu cita <i class="fa fa-arrow-right"></i></a></li>
													</ul>
											</div>
										</div>
									</div>
		...
		<div class="cta">
			<div class="parallax_background parallax-window"
				data-parallax="scroll" data-image-src="images/cta_1.jpg"
				data-speed="0.8"></div>
			<div class="container">
				<div class="row">
					<div class="col">
		...
		<div class="stuff">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-7">
						<div class="faq">
							<div class="faq_title">Faq and Stuff</div>
								...
								<div class="accordions">
									...
									<div class="accordion_container">
										...
										<div class="accordion_panel">
											<div>
												<p>Lorem ipsum dolor sit amet, lorem maximus consectetur
									...
									<div class="accordion_container">
										<div class="accordion d-flex flex-row align-items-center">
											<div>Duis quis lacinia elit. Etiam varius mi eget lacus
												ultricies elementum</div>
										</div>
										<div class="accordion_panel">
											<div>
												<p>Lorem ipsum dolor sit amet, lorem maximus consectetur
		...
		<footer class="footer">
		<div class="parallax_background parallax-window"
			data-parallax="scroll" data-image-src="images/footer.jpg"
			data-speed="0.8"></div>
							...
							<div class="footer_contact_form_container">
								<form action="#" class="footer_contact_form"
									...
									<div
										...
										<input type="text" class="footer_contact_input"
											placeholder="Name" required="required"> <input
											type="email" class="footer_contact_input"
